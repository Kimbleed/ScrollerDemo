...
public class VideoContainerView2 extends LinearLayout {
    private static final String TAG = "VideoContainerView2";
    //控件是否能平移
    ...
    public VideoContainerView2(Context context) {
        this(context, null);
    }

    public VideoContainerView2(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public VideoContainerView2(Context context, AttributeSet attrs, int defStyle) {
    ...
    private void init(Context context, AttributeSet attrs) {
        //获得自定义属性
        TypedArray typedArray = context.obtainStyledAttributes(attrs, R.styleable.VideoContainerView2);
        //最大缩放比例因子
        float maxScaleFactor = typedArray.getFloat(R.styleable.VideoContainerView2_max_scale_factor, DEFAULT_MAX_SCALE_FACTOR);
        //最小缩放比例因子
        float minScaleFactor = typedArray.getFloat(R.styleable.VideoContainerView2_min_scale_factor, DEFAULT_MIN_SCALE_FACTOR);
        //是否能够平移回弹
        boolean canBackTranslate = typedArray.getBoolean(R.styleable.VideoContainerView2_can_back_translate, true);
        //是否能够旋转回弹
        boolean canBackRotate = typedArray.getBoolean(R.styleable.VideoContainerView2_can_back_rotate, true);
        //是否能够缩放回弹
        boolean canBackScale = typedArray.getBoolean(R.styleable.VideoContainerView2_can_back_scale, true);
        //动画持续的事件
        int animatorTime = typedArray.getInt(R.styleable.VideoContainerView2_animator_time, DEFAULT_ANIMATOR_TIME);
        typedArray.recycle();
        //设置自定义属性
    ...
    private void upDateBoundRectF() {
        mBoundRectF.set(0,0,getWidth(),getHeight());
